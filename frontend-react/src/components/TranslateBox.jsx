    ...
    <div>
      ...
      <div style={{ position: 'relative' }}>
        <textarea
          ...
          style={{
            ...
            paddingBottom: '32px', background: 'var(--bg)',
        ...
        <span style={{
          ...
          fontSize: '12px', color: text.length > 900 ? '#ff6060' : 'var(--text-dim)',
        }}>
          {text.length} / {MAX}
        </span>
      </div>
      <button
        ...
        style={{
          ...
          fontWeight: '700', cursor: loading || !text.trim() ? 'not-allowed' : 'pointer',
        }}
      >
